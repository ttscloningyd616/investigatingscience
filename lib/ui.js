...
var UI =
{
    ...
    init : function()
    {
        ...
        this.voiceOnButton = makeButton(460, 428, 140, 30, "voice on", true);
    ...
    drawAboutText : function()
    {
        ...
        ctx.strokeText("Pink Trombone but for an assessment", 300, 230);
        ctx.fillText("Pink Trombone but for an assessment", 300, 230);
    ...
    drawInstructionsScreen :  function()
    {
        ...
        this.write("");
        this.write("- touch the nasal cavity to open the velum that consists of muscle and connective tissue that forms the roof of the rear portion of the oral cavity. This allows to make the k, g, n as the tongue reaches the roof of your mouth. Let sound ");
        this.write("  flow through the nose.");
        this.write("");
        this.write("");
        this.write("(tap anywhere to continue mr webster)");
        ...
        ctx.textAlign = "left";
        this.write("Pink Trombone v2.0");
        this.write("by Neil Thapen originally but i made some changes yay");
        ctx.fillStyle = "red";
        ctx.globalAlpha = 0.6;
        this.write("https://classroom.google.com/u/0/c/NTAwNjk5NjQxNjNa/a/NDk1Mzc3Mjg4MDU1/details");

        /*ctx.beginPath();
        ctx.rect(34, 534, 229, 34);
